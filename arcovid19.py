...
class CasesPlot:
    ...
    def curva_epi_pais(
        ...
        **kwargs
        ...
        for code in sorted(CODE_TO_POVINCIA):
            ...
            self.curva_epi_provincia(provincia=code, ax=ax,
                                     log=log, norm=norm,
    ...
    def curva_epi_provincia(self,
        ...
        norm_factor = 1.
        if norm:
            ivco19 = "https://raw.githubusercontent.com/ivco19/libs/master/"
            CASES_URL_P = ivco19 + "databases/arg_provs.dat"
