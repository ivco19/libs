...
def plt_1country(df, country_name, fplot='new_plot.png'):
    """
...
def plt_ncountries(df, country_list=['Argentina'], fplot='new_plot.png'):
    """
...
def plt_continents(df, country_list=['Argentina'], fplot='new_plot.png'):
    """
    normalizado el tiempo al inicio del caso nro 100, la cantidad de
    infectados a la poblacion del pais, x millon de hab.
    """
...
def plt_paises(df, country_list=['Argentina'], fplot='new_plot.png'):
    """
    normalizado el tiempo al inicio del caso nro 100, la cantidad de
    infectados a la poblacion del pais, x millon de hab.
    """
